...
import { createJobType, resetJobTypeStatus } from '../../../feature/jobtype/jobTypeSlice';
...
const JobTypeCreate = () => {
  ...
  const handleOnSubmit = async (e) => {
    ...
    try {
      ...
      await dispatch(createJobType(formData)).unwrap();
      ...
      Swal.fire({
        title: "Success",
        text: "Job-Type is created successfully!",
        icon: "success",
        timer: 2000,
      });
      ...
      Swal.fire({
        title: "Failed",
        text: `Job-Type is failed to create - ${error}`,
        icon: "error",
        timer: 2000,
      });
    } finally {
