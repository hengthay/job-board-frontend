...
import { createCandidateProfile, resetCandidateProfileStatus } from "../../feature/candidateProfile/candidateProfileSlice";
...
const ProfileCreate = () => {
  ...
  const handleOnSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        title: "Success",
        text: "Profile is created successfully!",
        icon: "success",
        timer: 2000,
      });
      ...
      Swal.fire({
        title: "Failed",
        text: `Profile is failed to create - ${error}`,
        icon: "error",
        timer: 2000,
      });
    } finally {
